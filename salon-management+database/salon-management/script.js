...
function onConfirmSummary() {
  ...
  const request = sessionStorage.getItem("request");
    ...
    http.send(params);
    window.location = 'http://localhost/Philomena_beautysalon/test/kashipara.com_salon-management-database-/salon-management+database/salon-management/payment.php';
