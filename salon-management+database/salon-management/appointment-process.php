    ...
    if (!$checkResult) {
      ...
      if ($conn->exec($sql)) {
        ...
        try {
            ...
            $mail->Username   = 'philomena@gmail.com';                     // SMTP username
            $mail->Password   = 'Philomena';                               // SMTP password
            $mail->SMTPSecure = 'tls';                                  // Enable TLS encryption, `ssl` also accepted
            $mail->Port       = 587;                                    // TCP port to connect to

            //Recipients
            $mail->setFrom('philomena@gmail.com', 'Philomena');
