...
<html lang="en">
    ...
    <body <?php if (isset($_SESSION["id"])) {echo "onload='directNavigationBar()'";} ?> >
        <div class="main-container">
            <h1 id="indexTitle">PHILOMENA</h1>
            
            <p id="indexSubtitle">HAIR &amp; NAIL SALON</p>
            
            <div class="columnLeft">
                <img src="images/shutterstock_644982625.jpg" alt="model">
            </div>
            
            <div class="columnRight">
                <img src="images/shutterstock_1425769187.jpg" alt="model">
            </div>
            ...
            <div class="appointment-container">
                <div class='row'>
                    <div class='col-lg-7 col-xs-12 main_column'>
                        <img src='images/shutterstock_1740927845.jpg' title='barber'/>
                    </div>
        ...
        <section>
            ...
            <div class="appointment-container">
                ...
                <div class="col-lg-7 col-xs-12 main_column">
                    <img src="images/shutterstock_144022057.jpg" title="salon"/>
                </div>
                </div>
            </div>
        </section>
    ...
    <footer style="height:50vh;">
        <div id="firstfooter">
            <h1 class="indexTitle">PHILOMENA</h1>
            <p class="indexSubtitle">HAIR &amp; NAIL SALON</p>
            <div class="columnLeft">
                <img src="images/shutterstock_644982625.jpg" alt="model">
            </div>
            <div class="columnRight">
        ...
        <div id="lastfooter">
            <p> Copyright &copy; 2021 PHILOMENA beauty Salon All Rights Reserved</p>
        </div>
    </footer>
  ...
  var z = document.getElementById("logout-button");
