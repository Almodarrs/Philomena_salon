    ...
    <h1 class="display-4 text-center">Products</h1>
      <div class="user-inventory-container">
        ...
        <?php
          ...
          foreach($data as $row)
          {
             echo "<div class='col-lg-3 col-xs-3 product-list-img'><embed src='data:". $row['mime']. ";base64," . base64_encode($row['image_name']). "' width='250' height='250' /></br><span class='stock'><b>" . $row['status'] . "</b></span><span><b>EU " . $row['unitPrice'] . "</b></span>
