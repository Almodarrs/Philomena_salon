                        ...
                        <form method="POST" class="register-form" id="register-form" autocomplete="autocomplete" action="signup.php" onSubmit="return startSignUpValidate()">
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" id="name" placeholder="First Name" class="form-control" value="<?php echo str_replace(array("'", '"'), "",$name) ?>"/>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="tel" name="contact" id="contact" placeholder="Your post code" class="form-control" value="<?php echo str_replace(array("'", '"'), "",$tel) ?>"/>
                            ...
                            <div class="form-group">
                                ...
                                <a  class="existing-member" href="login.php" class="signup-image-link">I am already a member !</a>
                            </div>
                        </form>
                    </div>
